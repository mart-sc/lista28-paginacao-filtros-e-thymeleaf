package br.edu.unoesc.lista28.service_impl;
...
import br.edu.unoesc.lista28.repository.FuncionarioRepository;
...
public class FuncionarioServiceImpl implements FuncionarioService {
	...
	public void popularTabelaInicial() {
		repositorio.saveAll(List.of(
				...
				new Funcionario(null, "Alex Martini", "Rua B", 0, new BigDecimal("700.00"), LocalDate.of(2003, 9, 7))
			)
		);
	}
